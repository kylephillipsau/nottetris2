return {
	...
	{hold="down"}, {wait=8}, {shot="05_gameA_mid"}, {dump="d05_gameA_mid"},
	{hold="right"}, {wait=3}, {release="right"}, {hold="left"}, {wait=3}, {release="left"},
	{wait=20}, {dump="d06_gameA_late"}, {state="failingA", timeout=400}, {dump="d07_gameA_failing"}, {state="failed", timeout=400}, {release="down"}, {wait=1}, {shot="06_failed"},
